...
<body class="easyui-layout">
    ...
    <div class="menu-sidebar" data-options="region:'west',border:true,split:true,title:'菜单管理'">
    	<div class="easyui-accordion" data-options="border:false,fit:true" style="padding:;">
        	<div title="快捷菜单" data-options="iconCls:'application_cascade'">
                <ul class="easyui-tree menu-tree">
                    <li iconCls="icon-password"><a href="javascript:void(0)" data-icon="icon-password" data-link="/user/toPage1" iframe="0">密码修改</a></li>
                	<li iconCls="icon-user"><a href="javascript:void(0)" data-icon="icon-user" data-link="/WEB-INF/pages/allinfo.html" iframe="0">用户信息</a></li>
                </ul>
            </div>
        </div>
    </div>
